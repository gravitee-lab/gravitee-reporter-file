 ...
 */
public abstract class CsvTransformer<T extends Reportable> implements Transformer<T> {
    ...
    void appendString(Buffer buffer, String value, boolean escape, boolean last) {
        ...
        if (! escape || value == null || containsNone(value, CSV_SEARCH_CHARS)) {
            ...
            buffer.appendString(StringUtils.replace(value, CSV_QUOTE_STR, CSV_QUOTE_STR + CSV_QUOTE_STR));
        }
