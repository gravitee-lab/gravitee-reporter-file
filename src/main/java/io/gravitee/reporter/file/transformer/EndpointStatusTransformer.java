 ...
 */
package io.gravitee.reporter.file.transformer;
 ...
 */
public class EndpointStatusTransformer extends CsvTransformer<EndpointStatus> {

    @Override
    public Buffer transform(EndpointStatus status) {
    ...
    private void append(Buffer buffer, List<Step> steps) {
        if (steps != null && !steps.isEmpty()) {
            ...
            appendString(buffer, Boolean.toString(last.isSuccess()));
