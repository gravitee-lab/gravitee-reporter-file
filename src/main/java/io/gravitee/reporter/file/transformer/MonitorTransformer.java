 ...
 */
public class MonitorTransformer extends CsvTransformer<Monitor> {

    @Override
    public Buffer transform(Monitor monitor) {
        final Buffer buffer = Buffer.buffer();

        // Write info about OS
        appendString(buffer, Short.toString(monitor.getOs().cpu.percent));
